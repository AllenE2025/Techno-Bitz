    ...
    <AdminLayout>
        <div class="max-w-3xl space-y-6">
            ...
            <div class="flex items-center gap-4">
                ...
                <div>
                    <h1 class="font-display text-3xl font-bold text-white">Add Product</h1>
                    <p class="text-zinc-400 mt-1 text-sm">Fill in the details to add a new product</p>
                </div>
            </div>
            ...
            <form @submit.prevent="submit" class="space-y-5">
                ...
                <div class="bg-zinc-900 border border-zinc-800 rounded-xl p-6 space-y-5">
                    ...
                    <div>
                        ...
                        <input v-model="form.name" type="text" placeholder="e.g. Logitech G502 Hero"
                    ...
                    <div>
                        ...
                        <textarea v-model="form.description" rows="4" placeholder="Describe the product..."
