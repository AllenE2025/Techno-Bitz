    ...
    <AdminLayout>
        <div class="max-w-2xl space-y-6">
            ...
            <div class="flex items-center gap-4">
                ...
                <div>
                    <h1 class="font-display text-3xl font-bold text-white">Add Category</h1>
                    <p class="text-zinc-400 mt-1 text-sm">Create a new product category</p>
                </div>
            </div>
            ...
            <form @submit.prevent="submit" class="space-y-5">
                ...
                <div class="bg-zinc-900 border border-zinc-800 rounded-xl p-6 space-y-5">
                    ...
                    <div>
                        ...
                        <input v-model="form.name" type="text" placeholder="e.g. Gaming Peripherals"
